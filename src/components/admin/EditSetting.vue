<template>
    <div class="modal" :class="{active : activeClass}">
      <div class="modal_container">
        <i class="fas fa-times close_modal" @click="closeMethod"></i>
        <form>
          ...
          <div class="d-flex flex-column align-items-start mb-3">
            ...
            style="display: none" 
            accept="image/*">
            <img class="mt-3" :src="imageSrc" height="200px" v-if="imageSrc">
          </div>
...
export default {
  ...
  methods: {
    ...
    addAdvantage () {
      ...
      let advantageArr = document.getElementsByClassName('advantages_arr')[0]
